...
OPTION(VAD_TEST_DEPS "Compile/execute tests of dependencies ?" OFF)
...
if(NOT _VigraAddDepIncludedOnce)
  ...
  function(VAD_CREATE_ACTIVATE)
    if(WIN32)
      ...
      configure_file("${VigraAddDepPath}/vad_activate.bat.in" "${CMAKE_BINARY_DIR}/cmake_vad/vad_activate.bat.generate" @ONLY)
      configure_file("${VigraAddDepPath}/vad_path.in" "${CMAKE_BINARY_DIR}/cmake_vad/vad_path.generate" @ONLY)
    endif()
  endfunction()
  ...
  if(WIN32)
    VAD_CREATE_ACTIVATE()
    file(GENERATE OUTPUT "${CMAKE_BINARY_DIR}/vad_activate_$<CONFIG>.bat" INPUT "${CMAKE_CURRENT_BINARY_DIR}/cmake_vad/vad_activate.bat.generate")
    file(GENERATE OUTPUT "${CMAKE_BINARY_DIR}/vad_deactivate.bat" INPUT "${VigraAddDepPath}/vad_deactivate.bat.in")
    file(GENERATE OUTPUT "${CMAKE_BINARY_DIR}/cmake_vad/vad_path_$<CONFIG>" INPUT "${CMAKE_CURRENT_BINARY_DIR}/cmake_vad/vad_path.generate")
  endif()
endif()
